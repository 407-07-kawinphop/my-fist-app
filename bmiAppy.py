...
if st.button("คำนวณค่า BMI 🎯"): 
   #แปลงค่าสวนสูงจาก cm เป็นเมตร ปล้วคำนวณ BMI 
   height_m = height_cm / 100 
   bmi = weight/(height_m** 2) 

   st.write("---") 
   st.header(f"ค่า ฺ?ณ ทของคุณคือ: **{bmi:.2f}**")
...
if bmi < 18.5: 
    ...
    st.info("💡คุณมน้ำหนักเกินเกณฑ์ (ท้วม)")
else: 
  st.error("🚨คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกำลังกาย") 

st.divider() 
st.write("นายกวินภพ กันทนาวินนท์ เลขที่7 ม.4/7 ") 
